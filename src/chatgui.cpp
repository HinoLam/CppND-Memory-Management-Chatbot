...
#include "chatlogic.h"
#include "chatgui.h"
#define __GXX_ABI_VERSION 1009  // solution cause https://knowledge.udacity.com/questions/155577
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //// STUDENT CODE
      // CODE ALREADY HAVE WHEN GET PROJECT
    ////

    // create chat logic instance
      //https://knowledge.udacity.com/questions/136364
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    std::cout<<"ChatBotPanelDialog Destruct " << std::endl;
